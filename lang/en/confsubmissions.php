...
$string['managedisableddates_help'] = 'Check any day you do not want offered to regular submitters as a preferred date. A user with permission to manage this activity\'s form settings still sees and can select every day, disabled or not, on the submission form.';
