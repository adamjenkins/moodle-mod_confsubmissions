...
$string['abstractmaxchars'] = 'Abstract character limit';
$string['abstractmaxchars_help'] = 'The maximum length of a submitted abstract, in characters. Set to 0 for no limit. Independent of the word limit below -- both, either, or neither may be set (e.g. a character limit suits Japanese/Zenkaku text, a word limit suits English).';
$string['abstractmaxwords'] = 'Abstract word limit';
$string['abstractmaxwords_help'] = 'The maximum length of a submitted abstract, in words. Set to 0 for no limit. Independent of the character limit above -- both, either, or neither may be set.';
...
$string['error:abstracttoolong'] = 'The abstract is too long: {$a}';
...
$string['error:titletoolong'] = 'The title is too long: {$a}';
...
$string['limitviolation'] = 'Exceeds the {$a->limit} {$a->type} limit (currently {$a->count}).';
...
$string['title'] = 'Title';
$string['titlemaxchars'] = 'Title character limit';
$string['titlemaxchars_help'] = 'The maximum length of a submitted title, in characters. Set to 0 for no limit. Independent of the word limit below -- both, either, or neither may be set (e.g. a character limit suits Japanese/Zenkaku text, a word limit suits English).';
$string['titlemaxwords'] = 'Title word limit';
$string['titlemaxwords_help'] = 'The maximum length of a submitted title, in words. Set to 0 for no limit. Independent of the character limit above -- both, either, or neither may be set.';
$string['track'] = 'Track';
