...
$string['confsubmissions:manageform'] = 'Manage submission form settings (limits, open/close dates, optional fields)';
...
$string['field_language'] = 'Presentation language';
$string['field_subtopic'] = 'Sub-topic area';
$string['field_teachingcontext'] = 'Teaching context';
...
$string['privacy:metadata:confsubmissions_fieldval'] = 'The submitter\'s answers to the optional fields enabled for this activity.';
$string['privacy:metadata:confsubmissions_fieldval:fieldname'] = 'The machine name of the optional field being answered.';
