...
$string['abstractmaxchars'] = 'アブストラクトの文字数制限';
$string['abstractmaxchars_help'] = '提出できるアブストラクトの最大文字数です。0 にすると制限なしになります。下の語数制限とは独立しており、両方・どちらか一方・どちらも設定しないことができます（例: 日本語の全角文字には文字数制限、英語には語数制限が適しています）。';
$string['abstractmaxwords'] = 'アブストラクトの語数制限';
$string['abstractmaxwords_help'] = '提出できるアブストラクトの最大語数です。0 にすると制限なしになります。上の文字数制限とは独立しており、両方・どちらか一方・どちらも設定しないことができます。';
...
$string['confirmunwithdraw'] = '応募「{$a}」の取り下げを解除しますか？ ステータスは「提出済み」に戻ります。';
...
$string['confsubmissions:manageform'] = '応募フォームの設定（文字数制限、受付開始・終了日時、希望日の無効化）を管理する';
$string['confsubmissions:managenotifications'] = '通知テンプレートを管理する';
$string['confsubmissions:managetracks'] = '応募トラック・任意項目・応募タイプを管理する';
...
$string['disabledaycheckbox'] = '{$a} を無効にする';
$string['disableddatereason'] = '理由（任意）';
$string['disableddatereasonfor'] = '{$a} を無効にする理由（任意）';
...
$string['error:abstracttoolong'] = 'アブストラクトが長すぎます: {$a}';
$string['error:closebeforeopen'] = '受付終了日を受付開始日より前の日付にすることはできません。';
$string['error:conferenceendbeforestart'] = '開催終了日時は開催開始日時より後にしてください。';
$string['error:fieldtypechangehasvalues'] = 'この項目には既に回答が提出されているため、タイプを変更できません。項目を削除（回答も削除されます）してから新しい項目を追加してください。';
...
$string['limitviolation'] = '{$a->limit}{$a->type}の上限を超えています（現在{$a->count}）。';
$string['managedisableddates'] = '無効にする希望日程の管理';
$string['managedisableddates_help'] = '一般の応募者に希望日程として提示したくない日にチェックを入れてください。任意で短い理由（例：「会場が利用できません」）を入力できます。この理由は、応募フォーム上のグレーアウトされた日程の隣にカッコ書きで表示されます。このアクティビティのフォーム設定を管理する権限を持つユーザーには、無効化の有無にかかわらず、応募フォーム上ですべての日が表示され、選択できます。';
...
$string['submissionunwithdrawn'] = '応募の取り下げを解除しました。';
...
$string['title'] = 'タイトル';
$string['titlemaxchars'] = 'タイトルの文字数制限';
$string['titlemaxchars_help'] = '提出できるタイトルの最大文字数です。0 にすると制限なしになります。下の語数制限とは独立しており、両方・どちらか一方・どちらも設定しないことができます（例: 日本語の全角文字には文字数制限、英語には語数制限が適しています）。';
$string['titlemaxwords'] = 'タイトルの語数制限';
$string['titlemaxwords_help'] = '提出できるタイトルの最大語数です。0 にすると制限なしになります。上の文字数制限とは独立しており、両方・どちらか一方・どちらも設定しないことができます。';
$string['track'] = 'トラック';
