...
- **Withdraw & delete** — submitters can withdraw their own submission (reversible). An editing teacher with *Edit any submission* can Unwithdraw it, restoring whatever status (submitted/accepted/rejected) it held before being withdrawn — not simply resetting it to submitted. Managers can permanently delete any submission. An editing teacher with *Edit any submission* can also edit any submission, including its track, even after the call closes.
